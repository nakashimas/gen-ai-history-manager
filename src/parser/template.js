...
function peg$parse(input, options) {
  ...
  const peg$e1 = peg$literalExpectation("func:", false);
  ...
  function peg$f2(name, body) {
      return { type: "FunctionDef", name, body };
  }
  function peg$f3(name, args) {
      return { type: "Call", callee: name, args: args || [] };
  }
  function peg$f4(head, tail) {
      return [head, ...tail.map(t => t[3])];
  }
  function peg$f5(chars) {
      return { type: "StringLiteral", value: chars.join("") };
  }
  function peg$f6(digits) {
      return { type: "NumberLiteral", value: parseInt(digits.join(""), 10) };
  }
  function peg$f7() {    return { type: "BooleanLiteral", value: true };  }
  function peg$f8() {    return { type: "BooleanLiteral", value: false };  }
