...
export const ContentsNodeDefs: React.FC = () => {
  const foregroundTransform =
    `translate(-${NODE_WIDTH - 25},-${(NODE_WIDTH - 25) / 2})` +
    `scale(${(NODE_WIDTH - 25) / 960}, ${(NODE_WIDTH - 25) / 960})`;
